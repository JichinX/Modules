...
import com.codvision.step.main.StepManager;
...
public class MainActivity extends AppCompatActivity {
    ...
    private IStepService iSportStepInterface;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.stepArrayButton: {
                ...
                List<String> list = StepManager.getAllStep(getApplicationContext(), getApplication());
            ...
            case R.id.stepArrayButton1: {
                String step = StepManager.getStepByDate(getApplicationContext(), getApplication(), "2018-08-02");
                mStepArrayTextView.setText(step);
                /**
                 //根据时间来获取步数列表
                 if (null != iSportStepInterface) {
            ...
            case R.id.stepArrayButton2: {
                String step = StepManager.getStepByDateAndDays(getApplicationContext(), getApplication(), "2018-08-02", 1);
                mStepArrayTextView.setText(step);
                /**
                 //获取多天步数列表
                 if (null != iSportStepInterface) {
