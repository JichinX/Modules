package com.codvision.step.counter;
...
public class TodayStepCounter implements SensorEventListener {
    ...
    public static boolean CLEAN2 = true;
    ...
    public TodayStepCounter(Context context, OnStepCounterListener onStepCounterListener, boolean separate, boolean boot, ITodayStepDBHelper mTodayStepDBHelper) {
        this.mContext = context;
        this.mSeparate = separate;
        this.mBoot = boot;
        this.mOnStepCounterListener = onStepCounterListener;
        this.mTodayStepDBHelper = mTodayStepDBHelper;

        WakeLockUtils.getLock(mContext);

        sCurrStep = mTodayStepDBHelper.getCurrentStep(getTodayDate());
