...
import com.codvision.step.OnStepCounterListener;
import com.codvision.step.R;
import com.codvision.step.bean.StepData;
import com.codvision.step.counter.StepCounter;
import com.codvision.step.counter.TodayStepDetector;
import com.codvision.step.dao.TodayStepDBHelper;
import com.codvision.step.reciever.BaseClickBroadcast;
import com.codvision.step.utils.DateUtils;
import com.codvision.step.utils.Logger;
import com.codvision.step.utils.Microlog4Android;
import com.codvision.step.utils.SportStepJsonUtils;
import com.codvision.step.utils.WakeLockUtils;
...
import static com.codvision.step.utils.SportStepJsonUtils.getCalorieByStep;
import static com.codvision.step.utils.SportStepJsonUtils.getDistanceByStep;
...
//        getLock(this);
    ...
    private void addStepCounterListener() {
        ...
        stepCounter = new StepCounter(getApplicationContext(), mOnStepCounterListener, mSeparate, mBoot, mTodayStepDBHelper);
...
//        }
    ...
    private final ISportStepInterface.Stub mIBinder = new ISportStepInterface.Stub() {
        ...
        private JSONArray getSportStepJsonArray(List<StepData> stepDataArrayList) {
            return SportStepJsonUtils.getSportStepJsonArray(stepDataArrayList);
        }

        @Override
        public String getTodaySportStepArray() throws RemoteException {
            if (null != mTodayStepDBHelper) {
                List<StepData> stepDataArrayList = mTodayStepDBHelper.getQueryAll();
                jsonArray = getSportStepJsonArray(stepDataArrayList);
        ...
        public String getTodaySportStepArrayByDate(String date) throws RemoteException {
            if (null != mTodayStepDBHelper) {
                List<StepData> stepDataArrayList = mTodayStepDBHelper.getStepListByDate(date);
                jsonArray2 = getSportStepJsonArray(stepDataArrayList);
                Logger.e(TAG, jsonArray2.toString());
        ...
        public String getTodaySportStepArrayByStartDateAndDays(String date, int days) throws RemoteException {
            if (null != mTodayStepDBHelper) {
                List<StepData> stepDataArrayList = mTodayStepDBHelper.getStepListByStartDateAndDays(date, days);
                JSONArray jsonArray = getSportStepJsonArray(stepDataArrayList);
                Logger.e(TAG, jsonArray.toString());
                return jsonArray.toString();
            }
            return null;
        ...
        @Override
        public void cleanStep(String date) throws RemoteException {
            if (null != mTodayStepDBHelper) {
                mTodayStepDBHelper.delete(date, getApplicationContext());
                CURRENT_SETP = 0;
                updateNotification(CURRENT_SETP);
                StepCounter.CLEAN = false;
