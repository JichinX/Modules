...
import com.codvision.step.counter.TodayStepCounter;
...
public class TodayStepService extends Service implements Handler.Callback {
    ...
    public void onCreate() {
        ...
        mTodayStepDBHelper = TodayStepDBHelper.factory(getApplicationContext());//新建数据库实例，建表
...
//        getLock(this);
    ...
    private void addStepCounterListener() {
        ...
        stepCounter = new TodayStepCounter(getApplicationContext(), mOnStepCounterListener, mSeparate, mBoot,mTodayStepDBHelper);
    ...
    private final ISportStepInterface.Stub mIBinder = new ISportStepInterface.Stub() {
        ...
        public String getTodaySportStepArray() throws RemoteException {
            if (null != mTodayStepDBHelper) {
                ...
                jsonArray = getSportStepJsonArray(todayStepDataArrayList);
        ...
        public String getTodaySportStepArrayByDate(String date) throws RemoteException {
            if (null != mTodayStepDBHelper) {
                ...
                jsonArray2 = getSportStepJsonArray(todayStepDataArrayList);
