...
public final class MediaRecorderConfig implements Parcelable {
     ...
     * 获取摄像头所支持的尺寸的方式是{@link Camera #getSupportedPreviewSizes()}
    ...
    private MediaRecorderConfig(Buidler buidler) {
        ...
        this.RESULT_FLAG = buidler.RESULT_FLAG;
    ...
    public static class Buidler {
        ...
        public Buidler goHome(boolean GO_HOME, int flag) {
            this.GO_HOME = GO_HOME;
            this.RESULT_FLAG = flag;
            return this;
        }

        public Buidler resultFlag(int flag) {
            this.RESULT_FLAG = flag;
            return this;
        }
